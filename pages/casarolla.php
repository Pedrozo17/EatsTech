    ...
    <div class="container">
      ...
      <div class="footer-top grid-list">
        ...
        <div class="footer-brand has-before has-after">
          ...
          <a href="#" class="logo">
            <img src="../assets/images/logo.png" width="160" height="50" loading="lazy" alt="EATSTECH">
          </a>
          ...
          <a href="mailto:eatstech24@gmail.com" class="body-4 contact-link">eatstech24@gmail.com</a>

          <a href="tel:+573248933841" class="body-4 contact-link">+57 324 893 3841</a>

          <p class="body-4">
            Lun–Jue: 5:00 pm – 9:00 pm<br>
            Vie–Dom: 2:00 pm – 9:00 pm
          </p>
          ...
          <div class="social-links" style="margin-block: 16px;">
            <a href="https://www.facebook.com/profile.php?id=camaronexpressdeliverysc"
               target="_blank" class="social-link">
              <ion-icon name="logo-facebook"></ion-icon>
              <span>Camaron Express Delivery SC</span>
        ...
        <ul class="footer-list">
          ...
          <li><a href="#about"       class="label-2 footer-link hover-underline">Sobre Nosotros</a></li>
          <li><a href="#reservation" class="label-2 footer-link hover-underline">Contacto</a></li>
          <li><a href="./index.php"  class="label-2 footer-link hover-underline">Volver al inicio</a></li>
        </ul>

        <ul class="footer-list">
          <li>
            <a href="https://www.facebook.com/profile.php?id=camaronexpressdeliverysc"
               target="_blank" class="label-2 footer-link hover-underline">Facebook</a>
          </li>
          <li>
            <a href="https://www.instagram.com/camaron_express_delivery"
               target="_blank" class="label-2 footer-link hover-underline">Instagram</a>
          </li>
          <li>
            <a href="https://wa.me/573248933841"
               target="_blank" class="label-2 footer-link hover-underline">WhatsApp</a>
          </li>
          <li>
            <a href="https://wa.me/c/573248933841"
               target="_blank" class="label-2 footer-link hover-underline">Catálogo</a>
          </li>
        </ul>

        <iframe
          src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3976.380272494622!2d-74.23279642599842!3d4.70382474163251!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x8e3f77f0984e41b9%3A0x41da5ddac00c4306!2sColegio%20Sagrados%20Corazones%20Mosquera!5e0!3m2!1ses!2sco!4v1722558440323!5m2!1ses!2sco"
