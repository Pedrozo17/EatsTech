...
<header>
  <div class="logo-container">
    <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRkLmeInVKvMEWcVKjQEs4lx-M_xdj8kTtKpQ&s" class="logo">
    <div class="logo-containerr">
    <img src="../assets/images/logo_producto(1).png" class="logos">
  </div>
  <nav class="nav-pills">
        ...
        <div class="panel panel-default">
            <div class="panel-heading">
                ...
                <ul class="nav nav-pills">
                    <li role="presentation" class="active"><a href="../pages/REDTINDEX.HTML">Inicio</a></li>
                    <li role="presentation"><a href="../modules/carrito/VerCarta2.php">Carrito de Compras</a></li>
