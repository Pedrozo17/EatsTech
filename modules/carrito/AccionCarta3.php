...
include '../modules/menu/La-carta2.php';
$cart = new Cart;
...
if(isset($_REQUEST['action']) && !empty($_REQUEST['action'])){
    if($_REQUEST['action'] == 'addToCart' && !empty($_REQUEST['id'])){
        ...
        $redirectLoc = $insertItem?'../modules/menu/VerCarta2.php':'../pages/index2.php';
        ...
        //consulta("SELECT", "PRODUCTOS", "ID", "1");
        //consulta("INSERT", "PRODUCTOS", "ID")
        ...
        if($insertOrder){
            ...
            if($insertOrderItems){
                ...
                header("Location: ../pagos/Pagos2.php");
            }
        }else{
            header("Location: ../pagos/Pagos2.php");
        }
