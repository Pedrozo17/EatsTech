...
include '../modules/carrito/La-carta2.php';
$cart = new Cart;
...
if(isset($_REQUEST['action']) && !empty($_REQUEST['action'])){
    if($_REQUEST['action'] == 'addToCart' && !empty($_REQUEST['id'])){
        ...
        $redirectLoc = $insertItem?'../modules/menu/VerCarta2.php':'../modules/pages/index2.php';
        ...
        header("Location: ../modules/menu/VerCarta2.php");
        ...
        if($insertOrder){
            ...
            if($insertOrderItems){
                $cart->destroy();
                header("Location: ../modules/pagos/OrdenExito2.php?id=$orderID");
            }else{
                header("Location: ../modules/pagos/Pagos2.php");
            }
        }else{
            header("Location: ../modules/pagos/Pagos2.php");
        }
    }else{
        header("Location: ../modules/pages/index2.php");
    }
}else{
    header("Location: ../modules/pages/index2.php");
}