    ...
    <div class="container">
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                ...
                <div class="footBtn">
                    <a href="../carrito/carritodecompras.php" class="btn btn-warning"><i class="glyphicon glyphicon-menu-left"></i> Continue Comprando</a>
                    <a href="../carrito/AccionCarta.php?action=placeOrder" class="btn btn-success orderBtn">Realizar pedido <i class="glyphicon glyphicon-menu-right"></i></a>
                </div>
            </div>
